...
// Khởi tạo context
const SocketTransportationContextForBookingList = createContext();

// Khởi tạo socket
const socket = io('http://localhost:5010', { autoConnect: false });


const SocketTransportationContextProviderForBookingList = ({ children }) => {
    ...
    return(
        <SocketTransportationContextForBookingList.Provider value={{
            myself,
            updateLocation,
            updateRideList,
            rideList,
            ...
            {children}
        </SocketTransportationContextForBookingList.Provider>
    )
}

export { SocketTransportationContextProviderForBookingList, SocketTransportationContextForBookingList };