...
import { Avatar, Card as CardAntd, Badge, Button as ButtonAntd, Skeleton, Switch, Rate, Divider, Space, Tag, Empty } from 'antd';
        ...
        <>
                ...
                <>
                    <div className="header-section">
                        ...
                        <div className="inner-header flex">
                            ...
                            <h1>Xin chào <img className="rounded-circle img-thumbnail"
                            src="https://xsgames.co/randomusers/avatar.php?g=pixel&key=69" 
                            alt="" width="55" height="55" style={{border: 0}} /> {localStorage.getItem("fullName")} </h1>
            ...
            <div className="container">
                ...
                <div className="Trip d-flex flex-column" style={{height: '100vh'}}>
                    ...
                    <div className="btn-action-container d-flex justify-content-between">
                        <button onClick={ () => { window.location.href = "/register-trip" } } type="button" class="btn btn--yellow">
                        ...
                        <button type="button" class="btn btn--purple">
                            <span class="btn__txt">KHÁM PHÁ</span>
                            <i class="btn__bg" aria-hidden="true"></i>
                            <i class="btn__bg" aria-hidden="true"></i>
                            <i class="btn__bg" aria-hidden="true"></i>
                            <i class="btn__bg" aria-hidden="true"></i>
                        ...
                        <button type="button" class="btn btn--green">
                            <span class="btn__txt">HỖ TRỢ</span>
                            <i class="btn__bg" aria-hidden="true"></i>
                            <i class="btn__bg" aria-hidden="true"></i>
                            <i class="btn__bg" aria-hidden="true"></i>
                            <i class="btn__bg" aria-hidden="true"></i>
                        ...
                        <button type="button" class="btn btn--blue">
                            <span class="btn__txt">DỊCH VỤ KHÁC</span>
                            <i class="btn__bg" aria-hidden="true"></i>
                            <i class="btn__bg" aria-hidden="true"></i>
                            <i class="btn__bg" aria-hidden="true"></i>
                            <i class="btn__bg" aria-hidden="true"></i>
                    ...
                    <div className="row my-4">
                        <div className="col">
                            <div class="center-section">
                                <Badge.Ribbon text="-40%" color="cyan">
                                    <div class="article-card">
                                        <div class="content">
                                        <p class="date">10 tháng 2, 2024</p>
                                        <p class="title">Giảm giá cực mạnh trong tuần</p>
                                        </div>
                                        <img src={`${require("../../assets/images/super-sale-banner.png")}`} alt="article-cover" />
                                    </div>
                                </Badge.Ribbon>
                            </div>
                        </div>
                        ...
                        <div className="col">
                            <div class="center-section">
                                <Badge.Ribbon text="-50%" color="pink">
                                    <div class="article-card">
                                        <div class="content">
                                        <p class="date">9 tháng 2, 2024</p>
                                        <p class="title">Deal hời xuyên ngày đêm</p>
                                        </div>
                        ...
                        <div className="col">
                            <div class="center-section">
                                <Badge.Ribbon text="-90%" color="red">
                                    <div class="article-card">
                                        <div class="content">
                                        <p class="date">9 tháng 9, 2023</p>
                                        <p class="title">Khách hàng mới giảm giá mới</p>
                                        </div>
                                        <img src={require("../../assets/images/banner-taxi-customer.jpeg")} alt="article-cover" />
                                    </div>
                                </Badge.Ribbon>
                            </div>
                        </div>
